...
#             # Check if the text matches the expiration date format (XX.XX or similar)
#             if re.match(r'\d{2}[.,\']\d{2}', text):
#                 expiration_date = text

#         if expiration_date:
#             # Print the detected date to the console
#             print(f"Detected Expiration Date: {expiration_date}")

#             # Parse year and month from matched text
#             exp_month, exp_year = map(int, expiration_date)
...
#             draw.text((20, processed_image.height - 70), f"Exp Date: {exp_month:02}/{2000 + exp_year}", fill="white", font=font)
